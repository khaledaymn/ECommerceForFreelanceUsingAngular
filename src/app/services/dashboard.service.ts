...
export class DashboardService {
  ...
  getRecentSales(limit = 5): Observable<Sale[]> {
    ...
    return this.apiService.get<Sale[]>(`${this.endpoint}/recent-sales`, { limit })
  }

  /**
   * Get chart data for sales overview
   */
  getSalesChartData(period: "daily" | "weekly" | "monthly" | "yearly" = "monthly"): Observable<ChartData> {
    if (this.useMockData) {
      const mockChartData: ChartData = {
        ...
        datasets: [
          {
            label: "الإيرادات",
            data: [18000, 22000, 32000, 28000, 35000, 42000, 38000, 45000, 48000, 52000, 58000, 65000],
          },
        ],
      }
    ...
    return this.apiService.get<ChartData>(`${this.endpoint}/chart-data`, { period })
  }
}
